...
const content: contentSection[] = [
  {
    ...
    sectionHeader: {
      ...
      description: (
        <div>
          <span className="text-work_experience_orange">Frontend Developer</span> with <span className="text-work_experience_orange">2 years</span> of experience in the software industry
        </div>
      ),
    },
        ...
        <Container>
          <div className="min-h-screen relative">
            <FadeIn className="max-w-5xl pt-40 md:pt-[20vh] 2xl:pt-[30vh]">
              ...
              <p className="max-w-3xl">23 yo software engineer with a B.E. Electronics & Telecommunication with experience in Front-End and Back-End technologies.</p>
            </FadeIn>
